...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-HUTQ099\\SQLEXPRESS01;Initial Catalog=QuanLyThuVien;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BaoCao>(entity =>
        {
            entity.HasKey(e => e.MaBc).HasName("PK__BaoCao__272475A6C8B2E1F8");
        ...
        {
            entity.HasKey(e => new { e.MaPm, e.MaVach }).HasName("PK__ChiTietP__EF9E135EA37861B8");
        ...
        {
            entity.HasKey(e => e.MaVach).HasName("PK__CuonSach__8BBF4A1D9040D6A7");
        ...
        {
            entity.HasKey(e => new { e.MaDg, e.MaSach }).HasName("PK__DanhGiaS__EC06D122992E47E4");
        ...
        {
            entity.HasKey(e => e.MaDat).HasName("PK__DatTruoc__3D8883308E9AC8C6");
        ...
        {
            entity.HasKey(e => e.MaDg).HasName("PK__DocGia__27258660C300564D");

            entity.HasIndex(e => e.MaTk, "UQ__DocGia__27250071BC8DABDE").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__DocGia__A9D10534C9DAE6AB").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaLs).HasName("PK__LichSuCa__2725C7720C50EC7C");
        ...
        {
            entity.HasKey(e => e.MaLs).HasName("PK__LichSuDa__2725C772488C2686");
        ...
        {
            entity.HasKey(e => e.MaNv).HasName("PK__NhanVien__2725D70A6DA1B073");

            entity.ToTable("NhanVien");

            entity.HasIndex(e => e.MaTk, "UQ__NhanVien__27250071CE7BCC7F").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__NhanVien__A9D1053487574695").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaPm).HasName("PK__PhieuMuo__2725E7FF2B06790B");
        ...
        {
            entity.HasKey(e => e.MaPp).HasName("PK__PhieuPha__2725E7F2DF2C48E6");
        ...
        {
            entity.HasKey(e => e.MaSach).HasName("PK__Sach__B235742D6BF2EFED");
            ...
            entity.HasMany(d => d.MaTgs).WithMany(p => p.MaSaches)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaSach", "MaTg").HasName("PK__Sach_Tac__E047242ADD7095F6");
        ...
        {
            entity.HasKey(e => e.MaTg).HasName("PK__TacGia__272500740EF18524");
        ...
        {
            entity.HasKey(e => e.MaTk).HasName("PK__TaiKhoan__27250070D411F27B");

            entity.ToTable("TaiKhoan");

            entity.HasIndex(e => e.TenDangNhap, "UQ__TaiKhoan__55F68FC0635A1739").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaTl).HasName("PK__TheLoai__27250071DC5ECFAA");
        ...
        {
            entity.HasKey(e => e.MaTb).HasName("PK__ThongBao__2725006F4699A7CF");
